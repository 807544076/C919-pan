...
def generateCertificate():
    ...
    certString = x509.CertificateBuilder().subject_name(subjectInfo).issuer_name(issuer).public_key(
        keyString.public_key()).serial_number(x509.random_serial_number()).not_valid_before(
